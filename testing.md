...
У даній практичній роботі реалізовано unit-тестування backend та frontend частин веб-додатку **«Сувенірна лавка ХДУ»**.
...
**Unit-тест** — це автоматизований тест, який перевіряє окрему частину програми (функцію, метод, ендпоінт) ізольовано від інших компонентів.
