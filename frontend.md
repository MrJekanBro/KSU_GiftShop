...
Frontend для проєкту **KSU GiftShop** реалізовано у вигляді простого HTML/CSS/JS-прототипу.
...
- Показується каталог
- Кнопки фільтра працюють (показують лише товар вибраної категорії)
- Сортування за ціною й кількістю працює (одне натискання - змінює напрямок)
